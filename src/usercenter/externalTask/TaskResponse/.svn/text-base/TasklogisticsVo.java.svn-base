 ...
 *
 */
public class TasklogisticsVo implements Serializable{

	private static final long serialVersionUID = 1191909333439458509L;
	...
	private boolean         send;//是否是发送方
	private String          week;//星期几
	private int             file_count;//关联图片的个数

	
	@Override
	public String toString() {
		return "TasklogisticsVo [record_id=" + record_id + ", t_id=" + t_id
				+ ", tpye=" + tpye + ", start_date=" + start_date
				+ ", licence_plate=" + licence_plate + ", driver=" + driver
				+ ", phone_number=" + phone_number + ", confirm_state="
				+ confirm_state + ", remark=" + remark + ", send_id=" + send_id
				+ ", send_company=" + send_company + ", isSend=" + send + "]";
	}
