...
public class SupplierCheckfactoryReport {
	private int			id;
	...
	public String toString() {
		return "SupplierCheckfactoryReport [id=" + id + ", file_name="
				+ file_name + ", create_dt=" + create_dt + ", remark=" + remark
				+ ", mogodb_id=" + mogodb_id + ", check_score=" + check_score
				+ ", supplier_id=" + supplier_id + ", source_type="
				+ source_type + ", operator_id=" + operator_id
				+ ", operator_name=" + operator_name + ", check_factory_dt="
				+ check_factory_dt + ", send_company_id=" + send_company_id
				+ ", checkor=" + checkor + ", supplier_cpyname="
				+ supplier_cpyname + ", company_id=" + company_id + "]";
	}
}
