...
public class PurchaseCategoryCtrl {
	...
	public Map<String,Object> getPurchaseCategoryTree2Json(HttpServletRequest request,HttpServletResponse response) throws Exception
	{
		...
		Object object = redisTemplate.opsForValue().get("treelist");//全部获取
		if(object instanceof List<?>){
			treelist = (List<TreeModel>)object;
		}else{
			treelist = purchaseCategoryService.getPurchaseCategoryTree2Json(qryParam);
			redisTemplate.opsForValue().set("treelist", treelist , 100 , TimeUnit.SECONDS);
		}*/
