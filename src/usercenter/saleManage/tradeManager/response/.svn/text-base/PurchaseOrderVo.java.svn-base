...
public class PurchaseOrderVo {
	...
	private Date            e_opreate_dt;//完成时间
	private Date            u_opreate_dt;//提出终止时间
	private Date            end_create_dt;//终止时间
	private Date            cancel_create_dt;//取消时间
	private Date            confirm_dt;//终止的确认时间
	private String          mergerName;//采购方地址名
	...
	public Date getE_opreate_dt() {
		return e_opreate_dt;
	}
	public void setE_opreate_dt(Date e_opreate_dt) {
		this.e_opreate_dt = e_opreate_dt;
	}
	public Date getU_opreate_dt() {
		return u_opreate_dt;
	}
	public void setU_opreate_dt(Date u_opreate_dt) {
		this.u_opreate_dt = u_opreate_dt;
	}
	public Date getEnd_create_dt() {
		return end_create_dt;
	}
	public void setEnd_create_dt(Date end_create_dt) {
		this.end_create_dt = end_create_dt;
	}
	public Date getCancel_create_dt() {
		return cancel_create_dt;
	}
	public void setCancel_create_dt(Date cancel_create_dt) {
		this.cancel_create_dt = cancel_create_dt;
	}
