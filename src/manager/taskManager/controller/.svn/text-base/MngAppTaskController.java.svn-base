...
public class MngAppTaskController {
	@Autowired
	private MngAppTaskService appTaskService;
	@RequestMapping(value="/appTaskbg.do",method=RequestMethod.POST)
	@ResponseBody 
	public Map<String,Object> Modules(HttpServletRequest request,HttpServletResponse response) throws Exception{
		return WebUtil.DynamicCallCURD(request,response,appTaskService);
	}
