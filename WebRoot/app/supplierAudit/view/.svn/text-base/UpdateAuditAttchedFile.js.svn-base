Ext.define('srm.supplierAudit.view.UpdateAuditAttchedFile',{
	extend:'srm.ux.Panel',
	alias:'widget.update_audit_AttchedFileInfo',
	requires:[],
	overflowY: 'auto',
						...
						},
						{
							...
							items:[{
								...
								handler:function(grid,rowIndex,colIndex){
									...
									var mongo_id=rec.get('object_id');
									...
									{
										var rec = grid.getStore().getAt(rowIndex);
										var mogodb_id=rec.get('object_id');
	...
	loadfileData:function(auth_update_id)
	{
		var me=this;
