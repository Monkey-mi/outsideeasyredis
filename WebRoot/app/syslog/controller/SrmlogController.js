 ...
 * 平台错误记录的日志
 */
Ext.define('srm.syslog.controller.SrmlogController', {
   extend : 'Ext.app.Controller',
	...
	views:[
				'srm.syslog.view.SrmlogManager',
				'srm.syslog.view.SrmlogInfo'
	],
	refs:[
	            {ref:'srmlogManager',selector:'srmlogManager'},
		...
		me.control({
			...
			'srmlogManager':{
				afterrender:function(cmp){	
			        ...
			        me.errorstore.proxy.extraParams.nodeIdForGrid = "";
					me.errorstore.load();																							
				}
			},
			 ...
			 * 进行刷新
			 */
	        'srmlogManager #grid_head button':{
	            click:me.doSearchAccount
	        },
	        'srmlogManager #sysFunctionClassTree':{
