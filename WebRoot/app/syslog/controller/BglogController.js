 ...
 * 平台错误记录的日志
 */
Ext.define('srm.syslog.controller.BglogController', {
   extend : 'Ext.app.Controller',
	...
	views:[
				'srm.syslog.view.BglogManager',
				'srm.syslog.view.SrmlogInfo'
	],
	refs:[
	            {ref:'bgLogManager',selector:'bgLogManager'},
