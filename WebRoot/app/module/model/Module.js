Ext.define('srm.module.model.Module', {
	...
	fields: [
				...
				{name:'expanded'    ,	defaultValue:srm.Const.YESNO_TYPE_NO},
				{name:'leaf'        ,	defaultValue:srm.Const.YESNO_TYPE_YES},
				{name:'isvalid'     ,	defaultValue:srm.Const.YESNO_TYPE_YES},
