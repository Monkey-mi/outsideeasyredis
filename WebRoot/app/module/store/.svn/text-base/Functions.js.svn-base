Ext.define('srm.module.store.Functions',{
	...
	proxy: {
        ...
        extraParams:{model:'Function'},
        api: {
			create: 'common/Modules.do?method=addFunction',
			update: 'common/Modules.do?method=updateFunction',
			read:	'common/Modules.do?method=getFuncListByMId',
			destroy:'common/Modules.do?method=deleteFunction'
		},
        reader: {
			type: 'json',
			rootProperty: 'data',
