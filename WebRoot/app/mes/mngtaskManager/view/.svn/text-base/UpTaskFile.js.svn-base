Ext.define('srm.mes.mngtaskManager.view.UpTaskFile',{
	extend:'srm.ux.Window',
	alias : 'widget.upTaskFile',
	title:'文件上传',
	modal:true,
	width: 600,
				...
				items:[{
			        ...
			        buttons : [ '->', {  
                            ...
                            handler:function(){
                            	...
                            	var tf_id = me.currentrec.get('tf_id');
                            	form.submit({
				                    url : 'appTaskFile/taskFile.do',
				                    method:'POST',
				                    timeout : 20,
				                    params: {
				                    ...
				                    success : function(form, action) {
				                    	...
				                    	me.currentrec.set('object_id',action.result.fileName);
				                    	me.close();
				                    },
