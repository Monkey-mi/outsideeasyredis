Ext.define('srm.enquiryQuote.quoteManager.store.QuotationDetail', {
	extend: 'Ext.data.Store',
	reqiures: ['srm.enquiryQuote.quoteManager.model.QuotationDetail'],
	model: 'srm.enquiryQuote.quoteManager.model.QuotationDetail',
	pageSize: 15,
	proxy: {
		type: 'ajax',
		actionMethods : {  
