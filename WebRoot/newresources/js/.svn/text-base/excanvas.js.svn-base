// JavaScript Document// Copyright 2006 Google Inc.
//
...
(function() {
  ...
  var G_vmlCanvasManager_ = {
    ...
    init_: function(doc) {
      ...
      if (!doc.styleSheets['ex_canvas_']) {
        ...
        ss.cssText = 'canvas{display:inline-block;position:relative;overflow:hidden;' +
  ...
  contextPrototype.fillText = function(textToDraw, x, y) {
    ...
    vmlStr.push('<g_vml_:shape style="font:' + this.font + ';',
                    ...
                    ' position:absolute;',
                    ' left:' + (x - this.measureText(textToDraw).width) + 'px;',
