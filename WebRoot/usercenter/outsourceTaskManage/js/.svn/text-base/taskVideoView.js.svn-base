...
function fileLoadListVideo(){
	var url = 'taskFile/getTaskFileList2.do';
	var params={};
	params.t_id=taskid;
	params.file_type=3;
	var fn=function(result){ 			
			...
			for(var i=0;i<length;i++){
				...
				imageItem =imageItem+
				'<li><input style="display:none" value="'+image.tf_id+'"/><img title="'+image.file_name+'" onClick="loadNewSrc('+image.tf_id+')" src="'+imagenewsrc+'" /></li>';
