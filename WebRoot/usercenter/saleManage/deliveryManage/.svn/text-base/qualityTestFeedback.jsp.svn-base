	...
	<body class="bg_grey">
		...
		<div class="midd_wrap clearfix" >
			...
			<div class="midd_right_wrap" style="width:834px">
				<p class="sale_right_title"><span>质检反馈</span></p>
				<div class="mt20 ml10 feedbackList clearfix">
					<div class="searchCriteria">
						<div class="greycolor clearfix ">
							<div class="posR f_l">
								...
								<select id="dateSelect" class="dateSelect posA" onchange="chooseDate()">
									<option value="1">到货日期</option>
									<option value="2">质检日期</option>
								</select>
							</div>
							<div class="f_l ml4">
								...
								<input id="search_text" class="keywords " placeholder="请输入到货编号或者采购商名称进行搜索">
						...
						<div class="mt10 moreCriteria hide">
							<div>
								<span >产品名称：</span><input placeholder="请输入产品名称" id="search_product_name" class="number_input ml10"/>
								<span class="ml10">产品货号:</span><input placeholder="请输入产品货号" id="search_product_artno" class="number_input ml10"/>
							</div>
							<div class="mt10">
								<span >订单编号：</span><input placeholder="请输入订单编号" id="search_order_bh"  class="number_input ml10"/>
								<span class="ml10">合同编号:</span><input placeholder="请输入合同编号" id="search_agreement_bh" class="number_input ml10"/>
							</div>
						</div>
					</div>
					<!-- <div class="t_algin_r mt10">共&nbsp;<span id="total_count" class="redcolor">5</span>&nbsp;条记录</div> -->
...
<!-- 		<script type="text/javascript" src="/newresources/js/xcConfirm.js"></script> -->
		...
		<script type="text/javascript" src="/usercenter/saleManage/deliveryManage/js/qualityTestFeedback.js"></script>
		...
		<div class="feedback_list_head">
         ...
         {{for(var prop in it){}}
         		<div class="feedback_list_body mt10">
							<div class="listTip">
								...
								{{if(it[prop].pur_cpyname_cn.length>=15){
										var i=it[prop].sup_cpyname_cn.substr(0,15);
										var t=i+"...";
									}}
								<div class="posR" style="margin-left:401px;">
									<div class="item3 f_l">	
										<div class="item1_company" onmouseover="showAllName(this)" onmouseout ="hideAllName(this)">采购商：<span>{{= t}}</span></div>
									</div>
									<div class="hide posA totalName">{{=  replaceNullAsStr(it[prop].pur_cpyname_cn)}}</div>
								</div>
								{{}}}
								{{if(it[prop].pur_cpyname_cn.length<15){}}
								<div class="item3 f_l"><div>采购商：<span>{{= replaceNullAsStr(it[prop].pur_cpyname_cn)}}</span></div></div>
								{{}}}
							...
							<table class="feedbacks">
								...
								{{?}}
									...
									<td class="con2 bluecolor" valign="top">{{= replaceNullAsStr(it[prop].list[pro].check_result)}}</td>
